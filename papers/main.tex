...
\centering
\footnotesize
\caption{Greedy test accuracy for each agent across dataset. Single-seed results; ConPoLe / ConPoLe-local numbers from~\cite{poesia2021contrastive}. ``--'' denotes a cell awaiting a multi-seed re-run.}
