...
\begin{itemize}
    ...
    \item Finally, Figure~\ref{ablations} shows adding curiosity degrades performance. This contrasts with earlier work~\cite{dabelow2024symbolic}, where regular PPO (non-tree) improves performance when augmented with curiosity.
\end{itemize}
