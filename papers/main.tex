...
\centering
\footnotesize
\caption{Greedy test accuracy for each agent across dataset. Single-seed results; ConPoLe / ConPoLe-local numbers from~\cite{poesia2021contrastive}. ``--'' denotes a cell awaiting a multi-seed re-run. Both \textsc{ppo-tree-rc} and \textsc{ppo-tree-rc-buf} exceed the ConPoLe SOTA on poesia.}
...
ppo-tree-rc-buf  & 0.80  & 0.44  & \textbf{0.93} \\
\bottomrule
