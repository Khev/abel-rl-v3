...
% TODO (see markdowns/tasks.md, Phase 0):
%   - Add a representation-learning figure (e.g., t-SNE of node embeddings).
%   - Failure-mode analysis: cluster failures by equation type, give traces.
%   - "This is done by X" placeholder — figure out original intent.
